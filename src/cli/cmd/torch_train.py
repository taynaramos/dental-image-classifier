...
class TorchTrain:
    """Comando ``torch-train``: treina a CNN e salva o modelo."""

    name: ClassVar[str] = "torch-train"
    ...
    def __init__(self, subparsers: argparse._SubParsersAction) -> None:
        ...
        parser.add_argument(
            "--model-out",
            type=Path,
            default=Path("artifacts/torch_model.pth"),
            help="Caminho de saída para o checkpoint treinado (padrão: artifacts/torch_model.pth).",
        )
